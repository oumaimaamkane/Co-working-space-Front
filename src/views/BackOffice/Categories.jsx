        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center transition-opacity duration-300">
          <div className="bg-white p-6 rounded-lg shadow-lg w-1/3 relative">
            ...
            <input
              ...
              className="w-full px-4 py-2 mb-0.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-300"
            />
            {error && (
              <div className="flex items-center gap-2 text-red-800 px-1 rounded-lg text-sm"><BiCommentError /> {error}</div>
            )}
