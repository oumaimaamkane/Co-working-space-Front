...
function Packs() {
  return (
    <div>
        ...
        <div className="container mx-auto px-4 md:px-12">
          <div className="flex flex-col items-center justify-center">
            <Fade delay={1e2} cascade triggerOnce damping={1e-1}>
              ...
              />
              <p className="w-[280px]  text-gray-500  text-center mx-auto text-sm md:w-[795px] md:text-lg leading-8 my-8 mb-12 md:mb-20">
      ...
      <section
        className="bg-white px-4 md:px-12 bg-cover leading-tight bg-center bg-no-repeat"
