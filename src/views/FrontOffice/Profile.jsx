...
export default function Profile() {
  ...
  return (
    <div>
      ...
      <section className="container py-14 md:py-24 mx-auto px-4 md:px-12">
        <div className="rounded-[4px] bg-white">
          <div className="shadow-xl pb-5 rounded-[4px] text-gray-900">
            <div className="rounded-t-[4px] h-32 overflow-hidden">
              <img
            ...
            <div className="mx-auto w-28 h-28 md:w-32 md:h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
              <img
            ...
            <ul className="w-full md:w-1/5 mx-auto py-4 mt-2 text-gray-700 flex items-center justify-around">
              ...
              <div className="mt-6 md:mt-3 card-body">
                ...
                <div className="flex flex-wrap gap-1 items-center mt-2">
                  <div className="flex items-center mr-2">
                    ...
                    <label className="font-semibold">CreatedAT :</label>
                  </div>
                  <span className="text-gray-500">
                ...
                <div className="flex md:justify-end mt-2">
                  <div className="flex justify-between gap items-center">
                    <button className="text-sm text-center rounded-[8px] bg-blue-600 hover:shadow-lg font-[500] text-white px-4 py-2">
                      Edit
                    </button>

                    <button className="text-sm text-center rounded-[8px] bg-red-600 hover:shadow-lg font-[500] text-white px-4 py-2">
                      Delete
                    </button>
                  </div>
                </div>
            ...
            <main className="md:mx-8 my-8 pt-6 border-t pb-10 px-4 md:px-[30px]">
              <div className="flex items-center justify-between py-5 lg:py-6">
                <div className="flex items-center space-x-1">
                  <h2 className="text-xl font-medium text-slate-700 line-clamp-1 lg:text-[23px]">
                    Recent Reservations
                  </h2>
                </div>
              </div>
                ...
                <div className="border-2 rounded-lg shadow-lg bg-white">
                  ...
                  <div className="flex grow flex-col px-4 pb-5 pt-1 text-center sm:px-5">
                    <div className="mt-1">
                      <a
                        href="#"
                        className="text-lg font-medium text-gray-700 hover:text-blue-500 focus:text-blue-500 dark:text-gray-100 dark:hover:text-blue-300 dark:focus:text-blue-300"
                      >
                        Private Office
                      </a>
                    </div>
                    ...
                    <p className="my-2 grow text-gray-500 text-left line-clamp-3">
                    ...
                    <div>
                      <a
                        href=""
                        className="block bg-teal-500 hover:bg-teal-600 transition-all duration-500 text-white font-[500] px-6 py-3 mt-4"
                      >
                        View Details
                      </a>
                    </div>
