          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 gap-y-10 md:gap-y-12 md:gap-6">
            ...
            <div className="blog-item">
              <div className="blog-img h-[242px]">
                <img className="w-full h-full" src={images.blog1} alt="blog" />
              </div>
              <div className="blog-content mt-4">
                ...
                <p className="text-[14px] md:text-[16px] 2xl:text-2xl 2xl:leading-[45px] leading-7 text-[#666] mb-4">
            ...
            <div className="blog-item">
              <div className="blog-img h-[242px]">
                <img className="h-full w-full" src={images.blog1} alt="blog" />
              </div>
              <div className="blog-content mt-4">
                <h3 className="text-[#1E3954] text-[18px] md:text-[20px] 2xl:text-3xl font-semibold mb-2">
                  <a href="/">The Best Coworking Spaces in 2021</a>
