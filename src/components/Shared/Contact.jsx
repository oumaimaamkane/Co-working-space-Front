...
export default function Contact() {
  return (
    <section className="px-4 md:px-12 2xl:px-24 mb-14 md:mb-24">
      {/* Header */}
      <div className="w-full flex flex-wrap">
        <div className="w-full md:w-1/3 flex md:px-3">
          <Fade delay={1e2} cascade triggerOnce damping={1e-1}>
            <span className="p-4 2xl:p-8 2xl:leading-[40px] h-fit rounded-[50%] bg-[#EEF8F7] leading-5">
              <FontAwesomeIcon
                icon={faLocationDot}
                className="size-4 2xl:size-8 text-[#030303]"
              />
            </span>

            <div className="ml-4 md:ml-6">
              <h3 className="text-base md:text-lg 2xl:text-3xl font-semibold text-[#1E3954]">
                Address
              </h3>
              <p className="text-sm md:text-base 2xl:text-2xl text-gray-500 md:leading-7  mt-1 mb-14 md:mb-28">
            ...
            <form>
              <div className="">
                <input
                  ...
                  className="w-full text-sm md:text-base 2xl:text-xl p-4 border border-[#EBEBEB] rounded-lg mb-4"
                />
                <input
                  type="email"
